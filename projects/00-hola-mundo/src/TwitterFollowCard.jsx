...
export function TwitterFollowCard({ children, formatUserName, userName = 'unknow', name }) {
    
    const [isFollowing, setIsFollowing] = useState(false) //usesState devuelve un array
